...
export const TomarAsistencia = () => {
  ...
  return (
    <MainLayout>
      <div className="flex flex-col w-11/12  md:w-2/3 m-auto bg-yellow-50 my-4 rounded p-4 bg-white">
            ...
            <tbody className="text-center table-row-group">
              {carnetsLeidos.map((scan, i) => (
                <tr key={i} className={`table-row print:mb-4 `}>
                  ...
                  <td className="border break-inside-avoid">{scan.carnet}</td>
                  <td className="border break-inside-avoid">{scan.nombres}</td>
