...
export const Eventos = () => {
  ...
  const handleScan = (result: IDetectedBarcode[]) => {
    ...
    if (tempResults.find((item) => item == rawValue)) {
  ...
  return (
    <MainLayout>
      <div className="flex flex-col w-2/3 m-auto bg-yellow-50">
        ...
        >
          <h2 className="text-h2 m-auto">Asistencia de (Nombre de evento)</h2>
          <button
          ...
          <ul className="w-11/12 m-auto pb-10">
