...
export const Validate = () => {
  ...
  return (
    <div className="flex flex-col w-full">
      <h1 className="text-h1 text-YellowStrong mx-auto">
        Validación de carnet UNICA
      </h1>
      {!isCarnetValid ? (
        <div className="bg-white mx-auto mt-4 h-fit w-[400px] p-4 rounded">
          <h1 className="text-red-500 text-h3 text-center">Carnet inválido</h1>
        </div>
      ) : (
        <div className="bg-white mx-auto mt-4 h-fit w-[400px] p-4 rounded">
          <h1 className="text-green-500 text-h3 text-center">Carnet válido</h1>
          <div className="grid grid-cols-7">
            <span className="font-bold col-span-3">Tipo de carnet:</span>
            <p className="col-span-4">{carnetData?.name}</p>
            <span className="font-bold col-span-3">Código de carnet:</span>
